...
resource "jamfpro_app_installer" "text_expander" {
  name            = "TextExpander"
  enabled         = true
  ...
  notification_settings {
    notification_message  = "A new TextExpander update is available"
  ...
  self_service_settings {
    ...
    description                    = "TextExpander is allowed in our organization as an alternate browser."
  }
}
