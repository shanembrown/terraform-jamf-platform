...
resource "jamfpro_app_installer" "adobe_creative_cloud" {
  ...
  notification_settings {
    notification_message  = "A new Adobe Creative Cloud update is available"
  ...
  self_service_settings {
    ...
    description                    = "Adobe Creative Cloud is allowed in our organization as an alternate browser."
  }
}
