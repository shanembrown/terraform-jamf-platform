...
resource "jamfpro_app_installer" "nudge" {
  name            = "Nudge"
  enabled         = true
  ...
  notification_settings {
    notification_message  = "A new Nudge update is available"
  ...
  self_service_settings {
    ...
    description                    = "Nudge is allowed in our organization as an alternate browser."
  }
}
