...
locals {
  ios17_cis_lvl1_dict = {
    "Application Access" = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS17_cis_lvl1_enterprise-applicationaccess.mobileconfig"
    "Mail Policy"        = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS17_cis_lvl1_enterprise-mail.managed.mobileconfig"
    "Password Policy"    = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS17_cis_lvl1_enterprise-mobiledevice.passwordpolicy.mobileconfig"
  }
}
...
locals {
  ios18_cis_lvl1_dict = {
    "Application Access" = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS18_cis_lvl1_enterprise-applicationaccess.mobileconfig"
    "Mail Policy"        = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS18_cis_lvl1_enterprise-mail.managed.mobileconfig"
    "Password Policy"    = "${var.support_files_path_prefix}modules/compliance_iOS_cis_level_1/support_files/mobile_configuration_profiles/iOS18_cis_lvl1_enterprise-mobiledevice.passwordpolicy.mobileconfig"
  }
}
