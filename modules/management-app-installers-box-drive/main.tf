...
resource "jamfpro_app_installer" "box_drive" {
  name            = "Box Drive"
  enabled         = true
  ...
  notification_settings {
    notification_message  = "A new Box Drive update is available"
  ...
  self_service_settings {
    ...
    description                    = "Box Drive is allowed in our organization as an alternate browser."
  }
}
