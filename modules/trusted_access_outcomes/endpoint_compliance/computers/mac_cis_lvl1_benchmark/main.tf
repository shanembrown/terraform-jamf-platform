...
resource "jamfpro_smart_computer_group" "group_sequoia_computers" {
  name = "CIS Level 1 - Sequoia Computers [${random_id.entropy.hex}]"
  criteria {
    name        = "Operating System Version"
    search_type = "like"
    value       = "15."
...
resource "jamfpro_smart_computer_group" "group_sequoia_cis_lvl1_non_compliant" {
  name = "CIS Level 1 - Sequoia - Non Compliant Computers [${random_id.entropy.hex}]"
  criteria {
    name        = "Operating System Version"
    search_type = "like"
    value       = "15."
...
resource "jamfpro_policy" "policy_sequoia_cis_lvl1_audit" {
  name            = "CIS Level 1 - Audit (Sequoia) [${random_id.entropy.hex}]"
  enabled         = true
  trigger_checkin = true
  frequency       = "Ongoing"
  category_id     = jamfpro_category.category_sequoia_cis_lvl1_benchmarks.id
...
resource "jamfpro_policy" "policy_sequoia_cis_lvl1_remediation" {
  name            = "CIS Level 1 - Remediation (Sequoia) [${random_id.entropy.hex}]"
  enabled         = true
  trigger_checkin = true
  frequency       = "Ongoing"
  category_id     = jamfpro_category.category_sequoia_cis_lvl1_benchmarks.id
