...
resource "jamfpro_script" "script_cis_apply" {
  ...
  priority        = "AFTER"
  script_contents = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_scripts/cis_apply.sh")
...
resource "jamfpro_script" "script_cis_remove" {
  ...
  priority        = "AFTER"
  script_contents = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_scripts/cis_remove.sh")
  category_id     = jamfpro_category.category_cis_benchmarks.id
...
resource "jamfpro_script" "script_sonoma_cis_lvl1_compliance" {
  ...
  priority        = "AFTER"
  script_contents = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_scripts/sonoma_cis_lvl1_compliance.sh")
  category_id     = jamfpro_category.category_cis_benchmarks.id
...
resource "jamfpro_computer_extension_attribute" "ea_sonoma_cis_apply" {
  ...
  script_contents        = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_extension_attributes/sonoma_cis_apply.sh")
}
...
resource "jamfpro_computer_extension_attribute" "ea_sonoma_cis_remove" {
  ...
  data_type              = "STRING"
  inventory_display_type = "EXTENSION_ATTRIBUTES"
  script_contents        = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_extension_attributes/sonoma_cis_remove.sh")
}
...
resource "jamfpro_computer_extension_attribute" "ea_cis_failed_count" {
  ...
  data_type              = "INTEGER"
  inventory_display_type = "EXTENSION_ATTRIBUTES"
  script_contents        = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_extension_attributes/cis_compliance_failed_count.sh")
}
...
resource "jamfpro_policy" "policy_cis_apply" {
  ...
  self_service {
    ...
    self_service_description        = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_policies/sonoma_cis_lvl1_apply_self_service_desc.txt")
...
resource "jamfpro_policy" "policy_cis_remove" {
  ...
  self_service {
    ...
    self_service_description        = file("${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_policies/sonoma_cis_lvl1_remove_self_service_desc.txt")
    force_users_to_view_description = false
    feature_on_main_page            = false
  }
...
locals {
  cis_lvl1_macos_14_dict = {
    "Application Access"    = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-applicationaccess.mobileconfig"
    "Login Window"          = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-loginwindow.mobileconfig"
    "Managed Client"        = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-timed.mobileconfig"
    "MCX"                   = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-mcx.mobileconfig"
    "Safari"                = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-safari.mobileconfig"
    "Screen Saver"          = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-screensaver.mobileconfig"
    "System Policy Control" = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-systempolicy.control.mobileconfig"
    "Terminal"              = "${var.support_files_path_prefix}modules/trusted_access_outcomes/mac_cis_benchmark_full/support_files/computer_config_profiles/sonoma_cis_lvl1-terminal.mobileconfig"
  }
}
